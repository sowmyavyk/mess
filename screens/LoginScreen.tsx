...
if (!selectedGroup || !rollNo || !password) {
Alert.alert("Error", "Please fill in all fields.")
return
}
setLoading(true)
try {
const response = await fetch("https://iiitbhms.onrender.com/user/login", {
method: "POST",
headers: {
...
name: data.name, // Pass user name as well
})
} else {
...
<TouchableOpacity
style={[styles.button, { zIndex: open ? -1 : 1 }]}
onPress={handleNext}
disabled={loading}
>
